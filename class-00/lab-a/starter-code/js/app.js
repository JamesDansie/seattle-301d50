...
function displayPics(){
  ...
  // var and let have different scope declarations. let is only defined to that block of code inside {}, whereas var will declare globally, or to the entire function scope. let is more limited.
  console.log(viewed);
