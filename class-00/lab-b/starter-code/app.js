...
//    this refers to the joe instance of Student
// 2. What is "this" when joe.scopeArrow() is invoked?
//    this bubbles up to the window, and refers to the window object because => has no this.
// 3. Explain why "this" is different when an arrow function is used.
//    the arrow function has no scope, so this will bubble up and refer to the next 'this' it finds. The next 'this' is the window object that everything is define in.
